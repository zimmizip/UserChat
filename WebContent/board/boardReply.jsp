...
<body>
	<div class = "container">
		<form method = "post" action = "/UserChat/./boardReply" enctype = "multipart/form-data">
			<table class = "table table-bordered table-hover" style = "text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						...
						<td><textarea class = "form-control" rows = "10" name = "boardContent" maxlength = "2000" placeholder = "글 내용을 입력하세요."></textarea></td>
					</tr>
					<tr>
