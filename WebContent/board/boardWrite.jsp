...
<body>
	<div class = "container">
		<form method = "post" action = "/UserChat/./boardWrite" enctype = "multipart/form-data">
			<table class = "table table-bordered table-hover" style = "text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						...
						<td><textarea class = "form-control" rows = "10" name = "boardContent" maxlength = "2000" placeholder = "연애 상담 게시판입니다. &#13;&#10; &#13;&#10;그외 개수작, 광고등을  배설할 시 똥차에 실어 보내드립니다."></textarea></td>
					</tr>
					<tr>
